...
#
# class LoggerClass:
#     def __init__(self, logger_name, log_file_name, filename):
#         self.filename = filename
#         # Define API log level
#         API = 25
#         # "Register" new logging level
#         logging.addLevelName(API, 'api')  # addLevelName(25, 'MESSAGE')
#         # Verify
#         assert logging.getLevelName(API) == 'api'
#
#         # Ensure the logs directory exists
...
# short_log = LoggerClass('short_logger', 'dhcp_server_lease_runner', filename)
# whole_log = LoggerClass('whole_logger', 'whole_dhcp_server_lease_runner', filename)
#
# # short_log = LoggerClass('short_logger', 'dhcp_server_lease_runner')
# # whole_log = LoggerClass('whole_logger', 'whole_dhcp_server_lease_runner')
#
...
#     if level == 'debug':
#         short_log.logger.debug(message)
#         whole_log.logger.debug(message)
#     elif level == 'info':
#         short_log.logger.info(message)
#         whole_log.logger.info(message)
#     elif level == 'warning':
#         short_log.logger.warning(message)
#         whole_log.logger.warning(message)
#     elif level == 'error':
#         short_log.logger.error(message)
#         whole_log.logger.error(message)
#     elif level == 'critical':
#         short_log.logger.critical(message)
#         whole_log.logger.critical(message)
#     elif level == 'api':
#         short_log.logger.log(25, message)  # 25 is the level number for 'API'
#         whole_log.logger.log(25, message)  # 25 is the level number for 'API'
#
#
# def log_message_short(level, message):
#     if level == 'debug':
#         short_log.logger.debug(message)
#     elif level == 'info':
#         short_log.logger.info(message)
...
#
#
# def log_message_whole(level, message):
#     if level == 'debug':
#         whole_log.logger.debug(message)
#     elif level == 'info':
#         whole_log.logger.info(message)
